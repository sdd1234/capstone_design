/* ─────────────────────────────────────────────────────────────
   iOS 폰 프레임 (디자인 시안 frames/ios-frame.jsx 이식 — ES 모듈)
   베젤 + 다이나믹 아일랜드 + 상태바 + 홈 인디케이터만. 스크롤은 children이 담당.
   ───────────────────────────────────────────────────────────── */
  ...
  return (
    <div
      style={{
        ...
        fontFamily:
          '"Pretendard", -apple-system, system-ui, "Noto Sans KR", sans-serif',
    ...
    >
      ...
      {/* content slot — full height, no overflow here (children scroll) */}
